...
$file = str_replace($_SERVER['DOCUMENT_ROOT'], '/', $path . $new_name); // получить путь вида '/img/avatars/15.jpg'
mysql_query("UPDATE client SET avatar='$file' WHERE ClientID='$id';"); //Добавление в БД.
header("Refresh:0.5;url=http://localhost/SportClub2.0/views/client/clientid.php?id=$id")
?>